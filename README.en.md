...
[Magyar főoldal](README.md) · **English documentation**
...
This repository package is prepared under [Universal Professional GitHub Release Master Standard V4.2](docs/RELEASE_STANDARD.md). Project-specific gates are recorded in the [Release Contract](docs/RELEASE-CONTRACT.md), and final evidence/limitations in the [Release Audit](docs/RELEASE-AUDIT-V4.2.md). The V058 application artifact remains byte-identical.
