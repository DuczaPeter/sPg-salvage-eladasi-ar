...
> Nem hivatalos Star Citizen rajongói eszköz; nem áll kapcsolatban a Cloud Imperium vállalatcsoporttal.
...
Ez a repository-csomag a [Universal Professional GitHub Release Master Standard V4.2](docs/RELEASE_STANDARD.md) szerint készült. A projekt-specifikus gate-eket a [Release Contract](docs/RELEASE-CONTRACT.md), a végső bizonyítékokat és limitations állapotot a [Release Audit](docs/RELEASE-AUDIT-V4.2.md) rögzíti. Az alkalmazás V058 fájlja byte-pontosan változatlan marad.
