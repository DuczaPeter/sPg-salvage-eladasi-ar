...
## Release package standard V4.1 / V4.1 release-csomag

- Release Standard: `docs/RELEASE_STANDARD.md` — **V4.1**.
- Release Contract: `docs/RELEASE-CONTRACT.md`.
- Release Audit: `docs/RELEASE-AUDIT-V4.1.md`.
- Application artifact remains byte-identical V058; this package revision does not change runtime code.
- Package release status: **READY WITH LIMITATIONS**.
