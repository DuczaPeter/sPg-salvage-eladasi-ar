...
## V4.1 release-szabvány

Teljes GitHub release/package munka a `docs/RELEASE_STANDARD.md` V4.1 szerint indul, és mindig `docs/RELEASE-CONTRACT.md` rögzítésével kezdődik. A V058 jelen csomagolási köre kizárólag dokumentációs/release-metadata scope: az alkalmazás artifact byte-pontosan változatlan marad. A végső gate-eket és limitations állapotot a `docs/RELEASE-AUDIT-V4.1.md` rögzíti.
